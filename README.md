...
11. Look up `n`, `p`, `q`, `g keywords` or a number at the **omniprompt**: As the omniprompt recognizes `n`, `p`, `q`, `g` or numbers as commands, you need to prefix them with `g`, e.g., `g n`, `g g keywords`, `g 1984`.
