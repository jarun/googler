...
complete -c googler -s n -l count  -r      --description 'show N results (default 10)'
complete -c googler -s N -l news           --description 'show results from news section'
complete -c googler -s c -l tld    -r      --description 'country-specific search with top-level domain .TLD'
complete -c googler -s l -l lang   -r      --description 'display in language LANG'
...
complete -c googler -s t -l time   -r      --description 'time limit search [e.g. h5, d5, w5, m5, y5]'
